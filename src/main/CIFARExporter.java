...
public class CIFARExporter {
  public static void main(String[] args) throws IOException {
    ...
    BufferedReader labels = new BufferedReader(new FileReader("/Users/JC/Downloads/trainLabels.csv"));
    labels.readLine();
    ...
    for (int i = 1; i <= 50000; i++) {
      ...
      BufferedImage bufferedImage = ImageIO.read(new File("/Users/JC/Downloads/train/" + i + ".png"));
      data[i - 1] = getPixels(bufferedImage);
      target[i - 1][labelNames.get(labels.readLine().split(",")[1])] = 1;
    }

    System.out.println(Arrays.toString(target[0]));
